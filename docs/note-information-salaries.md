...
En arrivant sur le chantier, vous appuyez sur **Arrivée**. En partant, sur **Départ**. Pour
la coupure du midi, sur **Pause** puis **Reprise**.

Au moment précis où vous appuyez sur **Arrivée** ou sur **Départ** — et uniquement à ce
moment-là — l'application relève votre position et la compare à l'adresse du chantier, afin
d'attester que le pointage a bien été fait sur place.

### Ce qui n'est pas fait

Ces points sont importants, ils sont donc écrits noir sur blanc :

- **Vous n'êtes pas suivi ni localisé en continu.** Entre deux pointages, l'application
  n'enregistre aucune position.
- **Aucune position n'est relevée en dehors du temps de travail** : ni sur le trajet
  domicile-travail, ni pendant les pauses, ni le soir, ni le week-end.
- **Vos déplacements et vos trajets ne sont pas enregistrés.**
...
- **Qui a accès :** le dirigeant et, pour son équipe uniquement, le chef d'équipe. Chaque
  salarié accède à ses propres données. Aucune transmission à un tiers, en dehors du
  cabinet comptable pour l'établissement des bulletins de paie.

### Vos droits

Vous disposez d'un droit d'accès, de rectification, d'opposition et de limitation sur vos
données. **Le droit d'accès est immédiat :** l'écran « Mes heures » de l'application vous
donne à tout moment le détail de vos pointages, sans avoir à en faire la demande.
