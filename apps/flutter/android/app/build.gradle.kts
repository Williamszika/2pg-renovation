...
if (fichierCle.exists()) proprietesCle.load(FileInputStream(fichierCle))
...
android {
    namespace = "fr.pg2renovation.pointage"
    ...
    defaultConfig {
        ...
        applicationId = "fr.pg2renovation.pointage"
    ...
    signingConfigs {
        create("release") {
            ...
            storeFile = (proprietesCle["storeFile"] as String?)?.let { file(it) }
